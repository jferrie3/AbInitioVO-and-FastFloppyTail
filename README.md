...
A manuscript detailing the methods and demonstrating the utility of each of these algorithms can be found in [Journal of Physical Chemistry B](https://doi.org/10.1021/acs.jpcb.0c02924).  
...
### Creating an IDR Fusion Protein Structure
...
-term --IDR_Terminus Specify N or C to indicate which terminus contains the IDR
-clash --Remove_Clashes Remove clashes from structure via VDW sampling of IDR
-out --Output_PDB Name of the output PDB file
```
